    ...
    <main>
        ...
        <div class="ul-container">
            <div class="ul-about-cover-img">
                <img src="assets/img/about-cover-img.jpg" alt="Cover Image">
            </div>
        </div>
        ...
        <div class="ul-inner-page-container my-0">
            <section class="ul-about">
                <div class="row row-cols-md-2 row-cols-1 align-items-center ul-bs-row">
                    ...
                    <!-- img -->
                    <div class="col">
                        <div class="ul-about-img"><img src="assets/img/about-img-1.jpg" alt="About Image"></div>
                    </div>
                </div>
            </section>
        </div>
        ...
        <div class="ul-inner-page-container my-0">
            <section class="ul-about">
                <div class="row row-cols-md-2 row-cols-1 align-items-center ul-bs-row">
                    <!-- img -->
                    <div class="col">
                        <div class="ul-about-img"><img src="assets/img/about-img-2.jpg" alt="About Image"></div>
                    </div>
